...
//            printf("\n");
    ...
    if (coords[0] == 0)
        MPI_Scatter(matrixB, 1, column, localB, N3 * N4 / d[1], MPI_DOUBLE, 0, row_comm);
    if (coords[1] == 0)
        MPI_Scatter(matrixA, N1 / d[0], row, localA, N1 * N2 / d[0], MPI_DOUBLE, 0, column_comm);
    ...
    MPI_Bcast(localB, N3 * N4 / d[1], MPI_DOUBLE, 0, column_comm);
    MPI_Bcast(localA, N1 * N2 / d[0], MPI_DOUBLE, 0, row_comm);
